...
I think the topics in the lab helped me prepare for this project because a lot of the fundamentals we talked about in class were already practiced in the labs. Being able to create a website through the labs greatly helped with understanding. Some features that I felt unprepared were some of the flex and media queries.
